...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>ZaniaIT! - Making itworks for you</title>
 ...
 <link rel="shortcut icon" href="<?php echo $baseUrl;?>/img/ico/zania.png">
   ...
   <link rel="shortcut icon" href="<?php echo $baseUrl;?>/img/ico/favicon.ico">
    ...
    <!--new menu  -->
     <link rel="stylesheet" type="text/css" href="<?php echo $baseUrl;?>/css/anylinkmenu.css"> 
	  <script type="text/javascript" src="<?php echo $baseUrl;?>/js/menucontents.js"></script>
	 <script type="text/javascript" src="<?php echo $baseUrl;?>/js/anylinkmenu.js"></script>
