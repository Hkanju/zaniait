        ...
        <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
          ...
          <div class="nav-collapse">
			<?php $this->widget('zii.widgets.CMenu',array(
                    ...
                    'encodeLabel'=>false,
                    'items'=>array(
								 array('label'=>'Home', 'url'=>array('/site/index', 'view'=>'index'),), /** contacts us **/
							     array('label'=>'About Us', 'url'=>array('/site/page', 'view'=>'about'),), /**About us **/
							     array('label'=>'Services', 'url'=>array('/site/page', 'view'=>'servises'),), /**Services **/
								 array('label'=>'Clients', 'url'=>array('/site/page', 'view'=>'clients'),), /**Clients**/
								 //array('label'=>'Portfolio', 'url'=>array('/site/page', 'view'=>'portfolio'),), /**Portfolio **/
								  array('label'=>'Contact us', 'url'=>array('/site/page', 'view'=>'contact'),), /** contacts us **/
