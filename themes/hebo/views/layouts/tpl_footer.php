<section id="bottom" class="" style="background:#034D7F">
    <div class="container bottom"> 
    	<div class="row-fluid ">
            <div class="span3">
            	<h5>About us</h5>
                <p>Information about the company will be put here!</p>
                
                <p>This is just a designing phase,By Kanju!</p>
            ...
            <div class="span3">
            	<h5>Contact us</h5>
                <p>
                    Josam House 2nd floor Block B-25<br/>
                    Mwenge along Coca Cola Road<br/>
                    P: +255 764 157 777/ +255 716 059 934<br/>
                    E: zaniait.com<br/>
