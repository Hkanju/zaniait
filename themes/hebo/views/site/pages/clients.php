...
-->
       ...
       <div class="row-fluid">
            ...
            <button class="btn btn-large btn-danger" type="button">Easy To Work With US!</button>
  ...
  <div class="slider-bootstrap"><!-- start slider -->
          <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/slider/flickr/client-page.jpg" width="1500" height="430" />
    </div> <!-- /slider -->
