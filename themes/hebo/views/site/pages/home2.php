    	...
    	<div id="myCarousel" class="carousel slide" style="min-height:430px;">
          ...
          <div class="carousel-inner">
            <div class="active item" style="min-height:430px;">
       	    	<img src="<?php echo Yii::app()->theme->baseUrl;?>/img/slider/flickr/s10.jpg" width="2500" height="2500" />
            
            </div>
            
            <div class="item" style=" min-height:430px;">
            	<img src="<?php echo Yii::app()->theme->baseUrl;?>/img/slider/flickr/s11.png" width="1000" height="430" />
            </div>
          </div>
          <!-- Carousel nav -->
